      ...
      >
        <nav className="flex flex-col border-t border-bone/10 bg-ink/95 px-6 pb-8">
          ...
          <Link
            href="/postulacion"
            onClick={() => setOpen(false)}
            className="mt-6 border border-violet-light px-5 py-3 text-center text-xs uppercase tracking-[0.18em] text-violet-light transition hover:bg-violet hover:text-bone"
          >
            Postulate
          </Link>
        </nav>
