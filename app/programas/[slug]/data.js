export const programs = [
  {
    ...
    incluye: [
      { icon: "User", label: "Guía UIAGM / IFMGA", sub: "Certificado" },
      { icon: "Package", label: "Logística completa", sub: "En montaña" },
      { icon: "Wrench", label: "Equipamiento grupal", sub: "Técnico" },
      { icon: "Home", label: "Alojamiento", sub: "Según itinerario" },
      { icon: "Radio", label: "Comunicaciones", sub: "Radios / Sat" },
      { icon: "Shield", label: "Seguro", sub: "Asistencia médica" },
    ],
    galeria: ["/images/pinnacle-back.jpg", "/images/fitzroy-approach.jpg", "/images/rope-team.jpg"],
...

  {
    ...
    galeria: ["/images/ice-couloir.jpg", "/images/rope-team.jpg", "/images/summit-clouds.jpg"],
...

  {
    ...
    headline: "El límite del\nalpinismo\nde élite.",
    incluye: [
      { icon: "User", label: "Guía UIAGM / IFMGA", sub: "Ratio 1:1" },
      { icon: "Package", label: "Logística completa", sub: "Gran pared" },
      { icon: "Wrench", label: "Equipamiento grupal", sub: "Alto rendimiento" },
      { icon: "Home", label: "Alojamiento", sub: "Vivac técnico" },
      { icon: "Radio", label: "Comunicaciones", sub: "2 radios Iridium" },
      { icon: "Shield", label: "Seguro", sub: "Helicoportación" },
    ],
    galeria: ["/images/rock-face.png", "/images/ice-couloir.jpg", "/images/pinnacle-back.jpg"],
...

  {
    ...
    incluye: [
      { icon: "User", label: "Guía AAGM", sub: "Certificado" },
      { icon: "Package", label: "Logística completa", sub: "En montaña" },
      { icon: "Wrench", label: "Equipamiento grupal", sub: "Crampones incluidos" },
      { icon: "Home", label: "Alojamiento", sub: "Campamento base" },
      { icon: "Radio", label: "Comunicaciones", sub: "Radio satelital" },
      { icon: "Shield", label: "Seguro", sub: "Asistencia médica" },
    ],
    galeria: ["/images/rope-team.jpg", "/images/ridge-walk.jpg", "/images/metodo-01.png"],
